...
export default defineNuxtConfig({
  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: process.env.URL ? process.env.URL : 'https://time-tracking.netlify.app' }
    ],
    link: [
  ...
  */
  ...
  // sitemap: {
  //   hostname: process.env.URL ? process.env.URL : 'https://time-tracking.netlify.app'
  // },
