<template>
  <popup-sheet class="fixed w-full max-w-2xl md:p-4" open>
    <div class="flex flex-col px-6 pt-6 pb-6 transition bg-white shadow-lg md:pb-3 rounded-t-2xl md:rounded-2xl">
      <transition enter-active-class="transition" enter-from-class="translate-x-4 opacity-0"
        leave-to-class="-translate-x-4 opacity-0" leave-active-class="transition" mode="out-in">
        <!-- Welcome screen -->
        ...
        <div v-else-if="page === 2" key="tutorial-2" class="flex flex-col items-center gap-2 text-center">
          ...
          <h2 class="mt-2 text-xl font-bold uppercase text-shortpause"
            v-text="$t('tutorials.onboarding.pages.2.title')" />
        ...
        <div v-else-if="page === 3" key="tutorial-3" class="flex flex-col items-center gap-2 text-center">
          ...
          <h2 class="mt-2 text-xl font-bold uppercase text-longpause"
            v-text="$t('tutorials.onboarding.pages.3.title')" />
        ...
        <div v-else-if="page === 4" key="tutorial-4" class="flex flex-col items-center gap-2 text-center">
          ...
          <h2 class="mt-2 text-xl font-bold uppercase text-amber-500"
            v-text="$t('tutorials.onboarding.pages.support.title')" />
